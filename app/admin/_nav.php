...
if (!function_exists('admin_tab_icon_svg')) {
  ...
  {
    return match ($key) {
      'candidate' => '<svg viewBox="0 0 24 24" aria-hidden="true" focusable="false"><path d="M12 12a4 4 0 1 0-4-4 4 4 0 0 0 4 4Zm0 2c-4.4 0-8 2.2-8 5v1h16v-1c0-2.8-3.6-5-8-5Z"/></svg>',
      ...
      'certifications' => '<svg viewBox="0 0 24 24" aria-hidden="true" focusable="false"><path d="M12 2.7c1.3 0 2.3 1 3.4 1.3 1.1.3 2.5 0 3.4.6.9.6 1.2 2 1.9 2.9.7.9 2 1.6 2.3 2.7.3 1.1-.4 2.4-.4 3.5s.7 2.4.4 3.5c-.3 1.1-1.6 1.8-2.3 2.7-.7.9-1 2.3-1.9 2.9-.9.6-2.3.3-3.4.6-1.1.3-2.1 1.3-3.4 1.3s-2.3-1-3.4-1.3c-1.1-.3-2.5 0-3.4-.6-.9-.6-1.2-2-1.9-2.9-.7-.9-2-1.6-2.3-2.7-.3-1.1.4-2.4.4-3.5s-.7-2.4-.4-3.5c.3-1.1 1.6-1.8 2.3-2.7.7-.9 1-2.3 1.9-2.9.9-.6 2.3-.3 3.4-.6 1.1-.3 2.1-1.3 3.4-1.3Z"/><circle cx="12" cy="12.3" r="4.6"/><path d="m10.1 12.2 1.5 1.5 2.8-2.8M7.8 18.9l-3 5 3.1-.8 1.4 2.7 2.4-4.1M16.2 18.9l3 5-3.1-.8-1.4 2.7-2.4-4.1"/></svg>',
