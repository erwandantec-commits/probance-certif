...
$questionStmt = $pdo->prepare("
  SELECT id, external_id, text, category
  FROM questions
  WHERE id = ?
  LIMIT 1
");
...
$uniqueUserStmt->execute([$qid]);
$failedUsers = (int)$uniqueUserStmt->fetchColumn();
...
$stmt = $pdo->prepare("
  ...
  LIMIT ? OFFSET ?
");
$stmt->bindValue(1, $qid, PDO::PARAM_INT);
...
<head>
  <meta charset="utf-8">
  <title>Admin &middot; Zoom &eacute;checs question</title>
