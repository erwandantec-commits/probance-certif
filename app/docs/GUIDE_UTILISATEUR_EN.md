...
In Exam mode, an **Abandon** button is available. If you use it, no score is calculated and the session is marked **Abandoned** — it does not count towards your certification, regardless of how many questions you had already answered correctly.
...
- the status: passed, failed, expired, or abandoned
...
- an expiry (time ran out) calculates a score on the questions answered — you can pass or fail depending on your score
- abandoning (Abandon button) calculates no score and never counts towards certification
...
The session is automatically closed and the score is calculated on the questions you had answered — you can pass or fail depending on your score versus the pack threshold.

### What happens if I abandon?

If you click the Abandon button, the session is immediately closed with no score calculated. The status is shown as **Abandoned** and it does not count towards your certification, regardless of how many correct answers you had given.
